        ...
        <div className="w-full max-w-[400px] space-y-8">
          ...
          <div className="text-center lg:text-left space-y-3">
            ...
            <p className="text-slate-500 font-medium">
              {isLoginMode 
                ...
                : "Rejoignez-nous pour révolutionner votre enseignement."}
            </p>
          </div>
          ...
          <AnimatePresence mode="wait">
            {error && (
               <motion.div
                 ...
                 exit={{ opacity: 0, y: -10 }}
                 className="bg-rose-50 text-rose-600 p-3 rounded-xl text-sm font-medium border border-rose-100"
               >
                 {error}
               </motion.div>
            )}
          ...
          <div className="pt-2">
            <form onSubmit={handleEmailAuth} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:bg-white transition-colors text-slate-900"
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  {isLoginMode && (
                    <a href="#" className="text-xs font-bold text-indigo-600 hover:text-indigo-700">Oublié ?</a>
                  )}
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-indigo-600 hover:bg-indigo-700 active:scale-[0.98] text-white font-bold py-3.5 rounded-xl transition-all shadow-md shadow-indigo-200 disabled:opacity-70 disabled:pointer-events-none flex justify-center items-center gap-2 mt-2"
              >
            ...
            <div className="my-6 flex items-center">
              ...
              <span className="flex-shrink-0 mx-4 text-sm font-medium text-slate-400">ou</span>
              <div className="flex-grow border-t border-slate-200"></div>
            </div>
          ...
          <p className="text-center text-xs text-slate-400 pt-6">
            ...
            <a href="#" className="font-medium text-slate-500 hover:text-slate-700">Conditions d&apos;utilisation</a>
            {" "}et notre{" "}
            <a href="#" className="font-medium text-slate-500 hover:text-slate-700">Politique de confidentialité</a>.
          </p>
        </div>
      </div>
    </div>
